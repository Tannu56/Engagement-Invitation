...
(() => {
  ...
  /* =====================================================================
     ...
     ===================================================================== */
  const EVENT_DATE = new Date('2026-08-14T00:00:00+05:30').getTime(); // exact ceremony time to be announced
  ...
  function initScratch() {
    ...
    scratchCtx.fillText('✨ Save The Date ✨', rect.width / 2, rect.height / 2);
    scratchCtx.font = `italic 300 ${Math.max(12, rect.width * 0.032)}px 'Cormorant Garamond', serif`;
    scratchCtx.fillText('scratch to reveal', rect.width / 2, rect.height / 2 + Math.max(20, rect.width * 0.05));
  }
  initScratch();
